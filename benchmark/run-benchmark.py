...
def transaction(puzzle):
    return f'({random_key()} ({puzzle()} (() (q (51 {random_key()} {random_key(3)})) ())))'
...
print(f'{Fore.GREEN}      TOTAL:{Style.RESET_ALL}' + ' %f s' % sum_time)
print(f'{Fore.GREEN}UNCERTAINTY:{Style.RESET_ALL}' + ' %f s' % sum_uncertainty)
